...
import string
import math
# sys.path.append('/home/doug919/projects/stanfordparser/stanford-parser-full-2015-04-20/stanford-parser.jar')
sys.path.append("/home/bs980201/projects/stanford-parser-python-r22186/3rdParty/stanford-parser/stanford-parser-full-2014-10-31/stanford-parser.jar")
...
class StanfordParser:
    ...
    def get_tokens(self,sentence): #by sven
        sentence = self.TAG.sub('', sentence)
        tokens = [unicode(x) for x in self.tokenize(sentence)]
        return tokens          
